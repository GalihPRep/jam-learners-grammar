...
The short vowel *o* is pronounced /o/, as the "o" in _hot_

* *kot* /kot/, _cut_
* *ogli* /oglɪ/, _ugly_

The short vowel *u* is pronounced /u/ (recognized as /ʊ/ by some authors), as the "u" in _good_
...
====== *aa*
The long vowel *aa* is pronounced /aː/, as the _a_ in _father_
...
* *saaf* /saːf/, _soft_
* *Naat Amerika* /naːt ameɹɪka/, _North America_
* *kwaat* /kwaːt/, _quart_
* *yaad* /jaːd/, _yard_
* *aad iez* /aːd iez/, _disobedient_
* *plaan* /plaːn/, _plant_
* *kaan* /kaːn/, _corn_
* *taak* /taːk/, _talk_
* *waata* /waːta/, _water_
...
====== *ii*
The long vowel *ii* is pronounced /iː/, as the "ee" in _beet_
...
====== *uu*
The long vowel *uu* is pronounced /uː/, as the "oo" in _moon_

* *buut* /buːt/, _booth / boot_
* *shuut* /ʃuːt/, _shoot_
* *byuuti* /bjuːtɪ/, _beauty_
...
* *yuut* /juːt/, _youngster_
* *myuuzik* /mjuːzɪk/, _music_
* *kuul* /kuːl/, _cool_
* *pyuuriti* /pjuːɹɪtɪ/, _purity_
* *fuud* /fuːd/, _food_
* *fyuu* /fjuː/, _few_
* *ruut* /ɹuːt/, _root_
* *hatityuud* /hatɪtjuːd/, _attitude_
* *nyuu* /njuː/, _new_
* *chruu* /ʧɹuː/, _through_
* *chuun* /ʧuːn/, _tune_
* *chuut* /ʧuːt/, _truth_
...
The diphthong *ie* is pronounced /ɪɛ/, as the "ye" in _yes_
...
* *jiel* /jɪɛl/, _jail_
* *biebi* /bɪɛbi/, _baby_
* *jinarieshan* /ʤinaɹɪɛʃan/, _relatives_
...
The diphthong *uo* is pronounced /uɔ/, as the "wa" in _want_

* *gruo* /gɹuɔ/, _grow_
* *uol* /uɔl/, _hole / whole / old_
* *kuoknat* /kuɔknat/, _coconut_
* *suos* /suɔs/, _source_
* *huoliip* /huɔliːp/, _many / a lot_
...
The diphthong *ou* is pronounced /ɔu/, as the "oa" in _boat_ or the "o" in _hole_
...
Likewise, the lengthened version *yaa* /jaː/ is equivalent to, and sometimes written as, *iaa*:

* *kyaahn* (*kiaahn*) /kjãː/, _cannot, can't_
* *gyaadn* (*giaadn*) /gjaːdn̩/, _garden_
* *kyaar* (*kiaar*) /kjaːr/, _car_
* *gyaad* (*giaad*) /gjaːd/, _guard_
* *kyaahn* or *kyaan* (*kiaahn* or *kiaan*) /kjãː/ or /kjaːn/, _cannot, can't_
* *pyaahn-pyaahn* (*piaahn-piaahn*) /pjãːpjãː/, _weak_
...
The consonant *ch* is pronounced /ʧ/, as the "ch" in _chair_

* *choch* /ʧoʧ/, _church_
* *chruu* /ʧɹuː/, _through_
* *chuun* /ʧuːn/, _tune_
* *chuut* /ʧuːt/, _truth_
* *chrikifai* /ʧɹikifai/, _cunning_
...
The consonant *j* is pronounced /ʤ/, as the "j" in _jump_

* *mieja* /mɪɛʤa/, _measure_
* *joj* /ʤoʤ/, _judge_
* *vijan* /vɪʤan/, _vision_

The consonant *k* is pronounced /k/, as the "c" in _cut_

* *kait* /kaɪt/, _kite_
* *kalij* /kalɪʤ/, _college_
* *kisaada* /kisaːda/, _cassava_
* *klaat* /klaːt/, _cloth_
* *kolcha* /kolʧa/, _culture_
* *konchri* /konʧɹi/, _country_
* *kom* /kom/, _come_
* *kot* /kot/, _cut_
...
* *chrezha* /ʧɹeʒa/, _treasure_
* *divizhan* /diviʒan/, _division_

NOTE: In the acrolect, *zh* may be replaced by *j* /ʤ/, for example: *pleja*, *vorjan*, *chreja*, *divijan*, etc.
...
|*ch* |/ʧ/ |*choch* |as the "ch" in _chair_
...
The combination *ky* is pronounced /kj/, as in the "c" in _cute_ (this sound is written with the symbol /c/ in IPA, but for clarity we have written it phonemically as /kj/):
...
* *chrabl* /ʧɹabl̩/, _travel_
* *chrai* /ʧɹaɪ/, _try_
* *chrang* /ʧɹaŋ/, _strong_
* *chrent* /ʧɹent/, _strength_
* *chriet* /ʧɹɪɛt/, _straight_
* *chrii* /ʧɹiː/, _tree, three_
* *chriit* /ʧɹiːt/, _treat_
* *chrik* /ʧɹik/, _trick_
* *chrikifai* /ʧɹikifai/, _cunning_
* *chrech* /ʧɹeʧ/, _stretch_
* *chrecha* /ʧɹeʧa/, _stretcha_
* *chrangga* /ʧɹaŋga/, _stronger_

*jr*

* *jraafut* /ʤɹaːfut/, _lame_
* *jred* /ʤɹed/, _Rastafarian_
* *jresbak* /ʤɹesbak/, _reverse_
* *jresdong* /ʤɹesdoŋ/, _shift position_
* *jriepop* /ʤɹɪɛpop/, _accost_
* *jraadong* /ʤɹaːdoŋ/, _reduced_
* *jraaz* /ʤɹaːz/, _drawers_
* *jraa* /ʤɹaː/, _draw_
* *jrap* /ʤɹap/, _drop_
* *jringk* /ʤɹiŋk/, _drink_
* *jrai* /ʤɹaɪ/, _dry_
* *jres* /ʤɹes/, _dress_
* *jrom* /ʤɹom/, _drum_
* *brejrin* /bɹeʤɹin/, _friend_
* *onjrid* /onʤɹid/, _hundred_
...
* *iejobl* /ɪɛʤobl̩/, _mature, as in person_
...
* *kuul* /kuːl/, _school_ (also *skuul*)
* *krichoul* /kɹiʧoul/, _owl_
...
Given names (also known as *Kristiyan niem*, _Christian names_) follow the same rules of phonology as other words (including loan words) in Jamaican. So _George_ becomes *Jaaj* (pronounced /ʤa:ʤ/), Mary becomes *Mieri* (pronounced /mɪɛɹi/), and so on.
...
* *Luwiiz* /luwiːz/, _Louise_
* *Mieri* /mɪɛɹi/, _Mary_
* *Nansi* /nansi/, _Nancy_
* *Puosha* /puɔʃa/, _Portia_
* *Sanja* /sanʤa/, _Sandra_
* *Siera* /sɪɛra/, _Sarah_
